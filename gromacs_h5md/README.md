...
* Since H5MD is GPL_v3 I can't really redistribute the specification, but the GROMACS module is ok.
  * It is fine to write implementations for I/O H5MD :)
  * I wrote the .mdwn module files, but I credited to the authors of GROMACS source for H5MD I/O, after our Zoom Call. 
